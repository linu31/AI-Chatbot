...
const Chatbot = () => {
    ...
    useEffect(() => {
        setMessages([
            {
                role: 'assistant',
                content: 'Hello! I’m Linux AI, here to assist you. What would you like to talk about? 😊',
    ...
    return (
        <Container className={`chat-container ${isDarkTheme ? 'dark-theme' : ''}`}>
            ...
            <h2 className="text-center mb-4 title">Linux AI</h2>

            <Card className="chat-card">
                <Card.Body>
                    <Card.Title>Chat with Linux AI</Card.Title>
                    <Row className="mb-3">
                                ...
                                <Row className={msg.role === 'user' ? 'justify-content-end' : 'justify-content-start'}>
                                    ...
                                    <Col xs="auto" className="p-0">
                                        <div className={`message-bubble ${msg.role === 'user' ? 'user-message' : 'bot-message'}`}>
                                            <strong>{msg.role === 'user' ? 'You' : 'Linux AI'}:</strong> {msg.content}
